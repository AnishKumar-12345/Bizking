...
import Visithealth from '@/views/pages/LivedataTracking/Visithealth.vue'
...
export default {
  ...
  data(){
    return{
      ...
      tabs : [
        {
          title: 'Retail chain level Visit Health status',
      ...
      currentDate: '', // Store the formatted date here
    }
  },
  computed: {
