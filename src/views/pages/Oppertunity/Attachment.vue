<template>
  <div>
    ...
    <VRow v-if="attachments.length === 0">
      <VCol cols="12"> 
          ...
          <VCardText> 
            ...
            >
              <VAlertTitle class="mb-1">
                Are you sure you Having Attachments?
              </VAlertTitle>
              <p class="mb-0">
                The system is not retrieving the Attachments. Please ensure that you have applied!
              </p>
            </VAlert>
          </VCardText>
        </VCard>
  ...
  computed:{
    filteredSalesHistory() {
      ...
      return this.attachments.filter(item => {
        ...
        return item.quatation_number && item.quatation_number.toLowerCase().includes(lowerCaseQuery) 
      })
    },
    paginatedItems() {
