          ...
          <VCardText>
            ...
            >
              <VAlertTitle class="mb-1">
                Are you sure you gave Purchase Orders?
              </VAlertTitle>
              <p class="mb-0">
                The system is not retrieving the Purchase Histories from Purchase Orders. Please ensure that you have applied for Purchase Orders !
              </p>
            </VAlert>
          </VCardText>
        </VCard>
    ...
    >
      ...
      <tbody>
        ...
        >     
          ...
          -->
          <td
            v-if="UserType == 'Business Head' || UserType == 'manager' || UserType == 'City Operations Manager'"
            class="text-center"
          >
            <VBtn
              icon
              ...
              >
                <VRow> 
                  ...
                  >
                    ...
                    <VAutocomplete
                      v-model="saveProduct.location_id"
                      label="Location"
                      :items="cityLoaction"               
                      item-value="value"
                      item-title="text"
                  ...
                  >
                    <VAutocomplete
                      v-model="saveProduct.brand_name"
                      label="Brand Name"
                      :items="BrandNames"               
                      item-value="value"
                      item-title="text"
                  ...
                  >
                    <VTextField
                      v-model=" saveProduct.total_given_margin"                
                  ...
                  >
                    <VTextField
                      v-model="saveProduct.bizkingz_cp_final"               
                      min="0"
                  ...
                  >
                    <VTextField
                      v-model="saveProduct.pitch_from "                
                  ...
                  >
                    <VTextField
                      v-model=" saveProduct.final_retail_cp"                
                      min="0"
                  ...
                  >
                    <VTextField
                      v-model=" saveProduct.bc_margin_amt "               
...
export default {    
  ...
  methods:{
    ...
    UpdateProduct(){
      const postData = {
        "brand_id":  this.saveProduct.brand_id,
        "brand_name": this.saveProduct.brand_name,
    ...
    editProduct(item){
      ...
      this.saveProduct.brand_name  = item.brand_name 
      this.saveProduct.brand_id = item.brand_id
