        ...
        >       
          ...
          <td class="text-center">
            <VBtn
              ...
              v-if="(item.so_status === 'Shipped' || item.so_status === 'Delivered' || item.so_status === 'Cancelled') && item.invoice_file !== ''"
              icon
              variant="text"
              color="default"
              class="me-2"
...
export default {
  ...
  methods:{
    ...
    editrow(id){ 
      ...
      if(this.userRoles === "Warehouse"){
        this.Getsalesperson( this.cityID,this.locationID).then(response=>{
