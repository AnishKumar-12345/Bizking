                ...
                <VCol cols="12">
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      <tr
                        v-for="(item, index) in filteredSalesOrder"
                        :key="index"
                      >
...
export default {
  ...
  data() {
    return {
      ...
      merchantrules: [v => !!v || 'Merchnat is required'],
      sorules: [v => !!v || 'SOData is required'],
    ...
    validateform() {
      this.$refs.purchaseOrderForm.validate().then(valid => {
        if (valid.valid) {
          ...
          const hasValidProduct = this.merchantProducts.some(
            product => product.quantity > 0 || product.return > 0 || product.exchange > 0,
          )
