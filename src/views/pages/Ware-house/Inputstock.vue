          ...
          <VCardText>
            ...
            >
              <VRow>
                ...
                >
                  <VTextField
                    v-model="inputStock.stock_updated_date"
                    type="date"
                    label="Date"
                    :min="today"
                    :rules="dateRules"
                ...
                >
                  ...
                  <!-- :items="['Draft', 'Created', 'Shared', 'Acknowledged', 'Received', 'Close']" -->
                  <VTextField
                    v-model="inputStock.invoice_number"
                    label="Invoice No"
                    :rules="InvoiceNo"
                  />
                </VCol>
                ...
                <VCol cols="12">
                  ...
                  >
                    ...
                    <tbody>
                      <tr
                        v-for="(item, index) in inputStockproducts"
                        :key="index"
                      >
